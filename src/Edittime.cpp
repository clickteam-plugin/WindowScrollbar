...
//	return "MyExt.chm";
	...
	return "Help\\WindowScrollBar.chm";
#else
	return NULL;
#endif // !defined(RUN_ONLY)
}
...
// -------------------------------------------------------
// GetActionTitle / GetConditionTitle / GetExpressionTitle
// -------------------------------------------------------
...
// ----------------------------------------------------------------------------
// GetActionCodeFromMenu / GetConditionCodeFromMenu / GetExpressionCodeFromMenu
// ----------------------------------------------------------------------------
...
// -------------------------------------------------------
// GetActionInfos / GetConditionInfos / GetExpressionInfos
// -------------------------------------------------------
...
// ----------------------------------------------------------
// GetActionString / GetConditionString / GetExpressionString
// ----------------------------------------------------------
// From a action / condition / expression code, returns 
